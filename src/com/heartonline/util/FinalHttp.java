...
import com.heartonline.util.http.*;
...
public class FinalHttp {
  ...
  //------------------put 请求-----------------------
    ...
    //---------------------下载---------------------------------------
    public HttpHandler<File> download(String url, boolean b, String target, AjaxCallBack<File> callback){
    	return download(url, null, target, b, callback);
    }
